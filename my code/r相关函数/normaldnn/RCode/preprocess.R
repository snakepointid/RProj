...
BuyWindDay <-(positiveActionInfo[type==4&cate==8,]$windowday%>%unique%>%sort(.,decreasing=T))[1:5]
...
negUserTargday <-negtiveActionInfo[,.(targwindowday=c(lastday-4,sample(BuyWindDay,1,replace = F)),label=0),.(user_id)]

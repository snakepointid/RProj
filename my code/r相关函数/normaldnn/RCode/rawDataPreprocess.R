#user info one hot 
userInfo<-fread('C:/Users/Administrator.NBJXUEJUN-LI/Desktop/project/RProj/my code/r相关函数/rawdatas/JData_User.csv',nrows = maxrows)
...
write.csv(userInfo,'C:/Users/Administrator.NBJXUEJUN-LI/Desktop/project/RProj/my code/r相关函数/rawdatas/JData_User_clean.csv')

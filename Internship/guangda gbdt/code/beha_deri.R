...
########
cat2num.vars<-c('phoneloc','birloc','constellation',"max_media_m3_cate","max_media_m6_cate"
...
#############################################
alldata<-value2odds(alldata,cat2num.vars,'default',lowest=50,-9999)
